...
function OrderTemplateRow(props) {
    ...
    return (
        <tr>
            ...
            <td><span className="fw-normal">{props.data.type}</span></td>
            <td>
                <a className="btn btn-secondary btn-xs ms-2" title="Edit this Template" href={"/orderTemplate/" + props.data.id}>
