    ...
    return (
        <div className="form-group">
            ...
            <div className="input-group">
                <input id="amount" type="text" list="amountOptions" className="form-control w-50" onChange={onAmountChange} placeholder="0" value={amountTemplate.amount || ''} />
                <span className="input-group-text bg-secondary">x</span>
                <input id="amountMultiplier" type="number" className="form-control" onChange={props.onChange} placeholder="1" value={amountTemplate.multiplier || ''} />
